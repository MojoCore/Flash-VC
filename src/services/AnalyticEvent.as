...
public class AnalyticEvent {
    ...
    public static const SESSION_CREATE:String='ANALYTICS_SESSION_CREATE';
    public static const ADD_TO_CART:String='ADD_TO_CART';
    public static const UPDATE_FROM_CART:String='UPDATE_FROM_CART';
    public static const REMOVE_FROM_CART:String='REMOVE_FROM_CART';
    public static const VIDEO_PLAY:String='VIDEO_PLAY';
    public static const SERVICE_NAME:String= 'analyticsevents';
    public static const  VIDEO_PROGRESS:String='VIDEO_PROGRESS';
    public static const  VIDEO_ENDED:String='VIDEO_ENDED';
    public static const ACTION_SHOW:String='ACTION_SHOW';
    public static const ORDER_SAVED:String='ORDER_SAVED';
